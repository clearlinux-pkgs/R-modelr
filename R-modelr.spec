...
Version  : 0.1.10
Release  : 57
URL      : https://cran.r-project.org/src/contrib/modelr_0.1.10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/modelr_0.1.10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668453816
