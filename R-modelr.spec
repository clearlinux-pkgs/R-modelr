...
Version  : 0.1.11
Release  : 60
URL      : https://cran.r-project.org/src/contrib/modelr_0.1.11.tar.gz
Source0  : https://cran.r-project.org/src/contrib/modelr_0.1.11.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679504929
