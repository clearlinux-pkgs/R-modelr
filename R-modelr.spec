...
Version  : 0.1.3
Release  : 14
URL      : https://cran.r-project.org/src/contrib/modelr_0.1.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/modelr_0.1.3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1549402848
